...
const PostsList = ({results, currentUser, hasMore, ready, count, totalCount, loadMore, showHeader = true, display}) => {
    ...
    return (
      <div className="posts-list">
        ...
        <div className="posts-list-content">
          {results.map(post => <Telescope.components.PostsItem post={post} key={post._id} display={display}/>)}
        </div>
